...
func test_orders{
    ...
    let (order_1) = IOrdersContract.push(orders_addr, is_bid=1, price=25, amount=1000, datetime=1666091715, owner=user, limit_id=1);
    let (order_2) = IOrdersContract.push(orders_addr, is_bid=1, price=24, amount=500, datetime=1666091888, owner=user, limit_id=1);
    let (order_3) = IOrdersContract.push(orders_addr, is_bid=1, price=25, amount=750, datetime=1666091950, owner=user, limit_id=1);
    ...
    let (order) = IOrdersContract.push(orders_addr, is_bid=1, price=25, amount=1000, datetime=1666091715, owner=user, limit_id=1);
    IOrdersContract.push(orders_addr, is_bid=1, price=24, amount=500, datetime=1666091888, owner=user, limit_id=1);
    IOrdersContract.push(orders_addr, is_bid=1, price=25, amount=750, datetime=1666091950, owner=user, limit_id=1);
    ...
    IOrdersContract.push(orders_addr, is_bid=1, price=25, amount=1000, datetime=1666091715, owner=user, limit_id=1);
    IOrdersContract.push(orders_addr, is_bid=1, price=24, amount=500, datetime=1666091888, owner=user, limit_id=1);
    IOrdersContract.push(orders_addr, is_bid=1, price=25, amount=750, datetime=1666091950, owner=user, limit_id=1);
