...
func print_order_list{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr} (
    ...
    %{
        print("    ", end="")
        print("id: {}, next_id: {}, prev_id: {}, is_bid: {}, price: {}, amount: {}, filled: {}, datetime: {}, owner: {}, limit_id: {}".format(ids.order.id, ids.order.next_id, ids.order.prev_id, ids.order.is_bid, ids.order.price, ids.order.amount, ids.order.filled, ids.order.datetime, ids.order.owner, ids.order.limit_id))
    %}
