...
// OpenZeppelin Contracts for Cairo v0.4.0b (token/erc20/library.cairo)
...
from lib.openzeppelin.security.safemath.library import SafeUint256
from lib.openzeppelin.utils.constants.library import UINT8_MAX
